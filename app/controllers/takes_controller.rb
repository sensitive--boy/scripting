class TakesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @take.save
        format.html { redirect_to(script_video_path(:id => @take.szene.sequence.video.id), :notice => 'Take was successfully updated.') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(script_video_path(:id => @take.szene.sequence.video.id)) }
      format.xml  { head :ok }
    end
  end
